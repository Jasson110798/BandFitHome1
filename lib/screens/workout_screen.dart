                      ...
                      AnimatedContainer(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text(
                              _isRest ? 'Chuẩn bị: ${widget.plan.exercises[_index + 1].name}' : ex.name,
                              textAlign: TextAlign.center,
                              style: Theme.of(context).textTheme.headlineSmall?.copyWith(fontWeight: FontWeight.w900),
                            ),
                            const SizedBox(height: 8),
                            Text(
                              _isRest ? 'Thả lỏng, hít thở đều rồi sẵn sàng cho động tác tiếp theo.' : '${ex.muscle} • ${ex.band}',
                              textAlign: TextAlign.center,
                            ),
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Text(_isRest ? 'giây nghỉ' : 'giây tập'),
                                    ],
                                  ),
                                ],
                              ),
